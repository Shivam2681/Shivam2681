...
**Frontend:** React.js, Next.js, TypeScript, JavaScript (ES6+), Tailwind CSS, Redux-Toolkit, Shadcn UI

**Backend:** Node.js, Express.js, RESTful APIs, JWT/OAuth Authentication
